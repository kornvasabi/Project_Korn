...
$('#DATE').change(function(){
	...
	$.ajax({
		url: '../SYS06/STRIncomeMonth/getendmonth',
		data: dataToPost,
		type: 'POST',
		dataType: 'json',
		success: function(data){
			$('#DATE').val(data.TODATE);
		}
	});
});
...
function printReport(){
	...
	IM_STR = $.ajax({
		url:'../SYS06/STRIncomeMonth/conditiontopdf',
		data:dataToPost,
		type:'POST',
		dataType:'json',
		success:function(data){
			var baseUrl = $('body').attr('baseUrl');
			var url = baseUrl+'/SYS06/STRIncomeMonth/pdf?condpdf='+data[0];
