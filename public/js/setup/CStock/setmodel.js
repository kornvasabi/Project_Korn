...
function search(){
	...
	dataToPost.CC = $('#CC').val();	
	dataToPost.MODELDESC = $('#MODELDESC').val();	
...
function afterSearch(){
	...
	$('.getit').click(function(){
		...
		dataToPost.MDDID = $(this).attr('MDDID');
		...
		Lobibox.confirm({
			...
			callback: function(lobibox, type){
				...
				if (type === 'ok'){
					...
					dataToPost.OMODEL 	= $('#t2MODEL').attr('model');
					dataToPost.MODEL 	= $('#t2MODEL').val();
					dataToPost.CC 		= $('#t2CC').val();
					dataToPost.RCC 		= $('#t2RCC').val();
					dataToPost.MEMO1 	= $('#t2MEMO1').val();
					dataToPost.MDDID 	= (typeof $('#t2MDDID').find(":selected").val() === 'undefined' ? '':$('#t2MDDID').find(":selected").val());
