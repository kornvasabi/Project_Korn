						...
						<div class='form-group col-sm-10 col-xs-10 col-sm-offset-1'>
							...
							<div class='row'>
								...
								<div class='col-sm-3 col-xs-3'>	
									<div class='form-group'>
										วันที่ขาย
										<input type='text' id='SDATE' class='form-control input-sm' style='font-size:10.5pt' placeholder='วันที่ขาย'  readonly>
									</div>
								</div>
								<div class='col-sm-3 col-xs-3'>	
									<div class='form-group'>
										จำนวนวันจากวันที่ขาย ถึง วันยึด
										<input type='text' id='DATEDIFF' class='form-control input-sm' style='font-size:10.5pt' placeholder='x วัน'  readonly>
									</div>
								</div>
								<div class='col-sm-3 col-xs-3'>	
									<div class='form-group'>
