...
//BEE+
class ReportARkangpay_xy extends MY_Controller {
	private $sess = array(); 
	...
	function index(){
				...
				<div class='col-sm-12 col-xs-12' style='height:100%;overflow:auto;font-size:10.5pt;'>					
					<div class='row' style='height:90%;'>
						<div class='col-sm-12 col-xs-12' style='background-color:#0067a5;border:5px solid white;height:75px;text-align:center;font-size:12pt;color:white;font-weight:bold;'>	
							<br>รายงานลูกหนี้ค้างชำระ x งวด - y งวด<br>
						</div>
						<div class='col-sm-10 col-xs-10 col-sm-offset-1'>	
							...
							<div class='col-sm-3 col-xs-3'>	
								<div class='form-group'>
									ถึงงวดที่
									<input type='text' id='EXPTO1' class='form-control input-sm' style='font-size:10.5pt' value='1'>
								</div>
							</div>
							<div class='col-sm-3 col-xs-3'>	
								<div class='form-group'>
									ขาดการติดต่อ (วัน)
									<input type='text' id='LATEFRM1' class='form-control input-sm' style='font-size:10.5pt' value=''>
								</div>
							</div>
							<div class='col-sm-3 col-xs-3'>	
								<div class='form-group'>
									ถึง (วัน)
									<input type='text' id='LATETO1' class='form-control input-sm' style='font-size:10.5pt' value=''>
								</div>
							</div>
						</div>
						<div class='col-sm-10 col-xs-10 col-sm-offset-1'>	
						...
						<div class='col-sm-10 col-xs-10 col-sm-offset-1'><br>	
							...
							<div class='col-sm-3 col-xs-3'>	
								<div class='form-group'>
									...
									<div class='col-sm-12 col-xs-12' style='border:0.1px dotted #d6d6d6;'>	
										<div class='form-group'><br>
											<input type='checkbox'  class='form-check-input' id='notexp1' name='exp'>  ไม่รวมลูกหนี้ที่ขาด x งวดแรก
										</div>
									</div>
								</div>
							</div>
		...
		$html.= "<script src='".base_url('public/js/SYS05/ReportARkangpay_xy.js')."'></script>";
		echo $html;
	}
	...
	function search(){
		...
		if(($dtrow->r) > 6000){
			...
			if($i>0){
				$html = "
					<div id='table-fixed-ReportARkangpay_xy' class='col-sm-12' style='height:100%;width:100%;overflow:auto;font-size:8pt;'>
						<table id='table-ReportARkangpay_xy' style='background-color:white;' class='col-sm-12 display table table-bordered' cellspacing='0' width='calc(100% - 1px)'>
							<thead>
							<tr style='height:40px;'>
								<th colspan='13' style='font-size:12pt;border:0px;text-align:center;'>รายงานลูกหนี้ค้างชำระ x งวด - y งวด</th>
							</tr>
			...
			$report = "
				<div id='table-fixed-ReportARkangpay_xy2' class='col-sm-12' style='height:100%;width:100%;overflow:auto;'>
					<table id='table-ReportARkangpay_xy2' class='col-sm-12 display table table-striped table-bordered' cellspacing='0' width='100%'>
						<thead>
							<tr>
								<th colspan='23' style='font-size:12pt;border:0px;text-align:center;'>รายงานลูกหนี้ค้างชำระ x งวด - y งวด</th>
							</tr>
							<tr>
	...
	function pdf(){
		...
		$content = "
			<table class='wf' style='font-size:7.5pt;height:700px;border-collapse:collapse;line-height:23px;overflow:wrap;vertical-align:text-top;'>
				<tbody>
					<tr>
						<th colspan='14' style='font-size:10pt;'>รายงานลูกหนี้ค้างชำระ x งวด - y งวด</th>
					</tr>
					<tr>
