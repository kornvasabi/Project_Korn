...
********************************************************/
class EditStrnoDetail extends MY_Controller {
	private $sess = array(); 
	...
	function index(){
								...
								<div class='form-group'>
									<div class='col-sm-12 col-xs-12' style='border:0.1px dotted #d6d6d6;background-color:#aeb6bf;'>	
										...
										<div class='col-sm-12'>
											<div class='form-group'>
												กลุ่มสินค้า
												<input type='text' id='GCODE' class='form-control input-sm 
												jzAllowNumber' 
												maxlength='3'>
											</div>
										</div>
										...
										<div class='col-sm-12'>
											<div class='form-group'>
												เลขไมค์
												<input type='text' id='MILERT' class='form-control input-sm 
												jzAllowNumber' 
												maxlength='12'>
											</div>
										</div>
		...
		";
		$html .="<script src='".base_url('public/js/SYS02/EditStrnoDetail.js')."'></script>";
		echo ($html);
	}
	function DetailCar(){
		...
		$sql = "
			...
			,USERID,DORECV,MANUYR,YSTAT,JOBDATE from {$this->MAuth->getdb('INVTRAN')} 
			where STRNO = '".$STRNO."'
		";
